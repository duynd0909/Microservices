...
import com.cmc.timesheet.constants.FileConstants;
import com.cmc.timesheet.model.response.FileResponse;
...
@RestController
@RequestMapping(FileConstants.API_MAPPING)
@CrossOrigin(origins = "*")
public class FileController {
    ...
    public ResponseEntity<FileResponse> uploadFile(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        FileResponse result = new FileResponse(fileName, fileDownloadUri, file.getContentType(), file.getSize());
